...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="pagename">Классы</xsl:variable>
  <xsl:template match="/">
    <html>
      <head>
  ...
  <xsl:template name="ClassArray">
    <xsl:for-each select="EditPasport/ClassGroup/ClassArray/item[count(. | key('key1', classType)[1]) = 1]">
                            ...
                            <div class="artt">
                              ...
                              <table cellspacing="1" class="tablesorter zagol-2" style='width: 98%;display:table;'>
                                <tbody>
                                  ...
                                  <xsl:if test="$link!=''">
                                    <tr>
                                      <td class="line-h14s">
                                        <b style="margin-right:5px;">Ссылка на сайт класса: </b>
                                  ...
                                  <xsl:if test="$link2!=''">
                                    <tr>
                                      <td class="line-h14s">
                                        <b style="margin-right:5px;">Ссылка на журнал: </b>
                                        <span style="vertical-align:top;">
                                  ...
                                  <xsl:if test="(Week!='') or (WeekText!='')">
                                    <tr>
                                      <td class="line-h14s">
                                        <b style="margin-right:5px;">Учебная неделя: </b>
                                        <xsl:if test="Week='5-ти дневная'">
                                          <span itemprop=''>5-ти дневная</span>
                                        </xsl:if>
                                        <xsl:if test="Week='6-ти дневная'">
                                          <span itemprop=''>6-ти дневная</span>
                                        </xsl:if>
                                        <xsl:if test="Week='Иное'">
                                          <span itemprop=''>
                                            <xsl:value-of select="WeekText"/>
                                          </span>
                                        </xsl:if>
                                      </td>
                                    </tr>
                                  ...
                                  <xsl:if test="(Smena!='')">
                                    <tr>
                                      <td class="line-h14s">
                                        <b style="margin-right:5px;">Сменность обучения: </b>
                                        <xsl:if test="Smena='1-ая смена'">
                                          <span itemprop=''>1-я смена</span>
                                        </xsl:if>
                                        <xsl:if test="Smena='2-ая смена'">
                                          <span itemprop=''>2-я смена</span>
                                        </xsl:if>
                                        <xsl:if test="Smena='3-ая смена'">
                                          <span itemprop=''>3-я смена</span>
                                        </xsl:if>
                                      </td>
                                    </tr>
                                  </xsl:if>
                                  <xsl:if test="Count!=''">
                                    <tr>
                                      <td class="line-h14s">
                                        <b style="margin-right:5px;">Нормативная наполняемость класса: </b>
                                        <span style="white-space:nowrap;">
                                          <span itemprop=''>
                                  ...
                                  <xsl:if test="Count2!=''">
                                    <tr>
                                      <td class="line-h14s">
                                        <b style="margin-right:5px;">Фактическая наполняемость класса: </b>
                                        <span style="white-space:nowrap;">
                                          <span itemprop=''>
                              ...
                              <xsl:for-each select="Teacher/*/Person/item">
                                ...
                                <h4 class="tog2 person" style="color:#555;font-size:10pt;padding-top:10px;padding-bottom:10px;">
                                  <b style="margin-right:5px;">Классный руководитель: </b>
                                  <span>
                                    <xsl:value-of select="Name"/>
                                  </span>
                                </h4>
                                <div class="art2" style="width:100%!important;padding:0;">
                                  <table cellspacing="1" class="tablesorter unit t_mobile" style='width: 100%;margin:0!important;'>
                                    <tbody>
                                      <tr>
                                        <td style='width: 120px' class="mob-clear">
